...
def _run_import_pipeline() -> None:
    ...
    try:
        result = bulk_import_all(
            ...
            term_ted=settings.import_term_ted,
            ted_days_back=settings.import_ted_days_back,
...
def get_scheduler_status() -> dict[str, Any]:
    ...
    return {
        ...
        "config": {
            ...
            "import_term_ted": settings.import_term_ted,
            "import_ted_days_back": settings.import_ted_days_back,
