...
Adds Stripe-related fields for plan management:
- plan: current tier (free/pro/business)
- stripe_customer_id: Stripe customer reference
- stripe_subscription_id: active subscription
- subscription_status: active/trialing/past_due/canceled/incomplete
- subscription_ends_at: when current period ends (for grace period after cancel)
"""
...
def upgrade() -> None:
    ...
    # Index for Stripe customer lookup (webhooks)
    op.create_index(
